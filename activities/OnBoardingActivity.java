...
import com.example.assignment_workshop_app.adapters.SliderAdapter;
    ...
    ViewPager.OnPageChangeListener changeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == 0) {
                ...
                animation = AnimationUtils.loadAnimation(OnBoardingActivity.this, R.anim.slide_animagtion);
