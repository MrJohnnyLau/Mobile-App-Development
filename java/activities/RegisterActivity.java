...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreference = getSharedPreferences("onBoardingScreen", MODE_PRIVATE);
        boolean isFirstTime = sharedPreference.getBoolean("firstTime", true);
        ...
        public void signup(View view) {
            ...
            if (userPassword.length() < 8) {
                Toast.makeText(this, "Password too short, please enter minimum 8 characters", Toast.LENGTH_SHORT).show();
                return;
            }
